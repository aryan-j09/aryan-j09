        ...
        <div class="container-fluid">
            <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT i.*, GROUP_CONCAT(CONCAT(a.attribute, ': ', a.value) SEPARATOR ', ') as attributes FROM `item_list` i LEFT JOIN `item_attributes` a ON i.id = a.item_id GROUP BY i.id ORDER BY i.name DESC");
