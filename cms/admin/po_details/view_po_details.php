...
<head>
    ...
    <style>
        ...
        .file-burger {
            padding: 6px 12px;  /* Match Bootstrap btn padding */
            height: 31px;       /* Match Bootstrap btn height */
            font-size: 14px;    /* Match Bootstrap btn font-size */
            display: inline-flex;
            align-items: center;
            gap: 5px;
            background: #fff;   /* Match btn-flat background */
            border: 1px solid #ddd;  /* Add border like other buttons */
            border-radius: 0;   /* Match btn-flat style */
            color: #343a40;     /* Match default button text color */
        }
        ...
        .file-burger .fas {
            font-size: 14px;    /* Match icon size with other buttons */
        }
